...
class TestLeilao(TestCase):
    ...
    def test_deve_retornar_o_maior_e_o_menor_lance_quando_adicionado_em_ordem_crescente(self):
        yuri = Usuario('Yuri')
    ...
    def test_nao_deve_permitir_propor_o_lance_caso_o_usuario_seja_o_mesmo(self):
